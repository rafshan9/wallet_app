            ...
            <View className="flex-1 justify-end bg-black/80">
                <View className="bg-very_dark_blue w-full rounded-t-[40px] p-8 border-2 border-black ">
                    ...
                    <View className="flex-row justify-between items-center mb-8">
                        <Text className="text-3xl font-rubik_bold text-white">
                    ...
                    <View className="flex-row bg-black/30 rounded-full p-1 mb-6">
                        ...
                        >
                            <Text className={`font-rubik_bold text-sm ${type === 'expense' ? 'text-black' : 'text-white/50'}`}>
                                Expense
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                        ...
                        >
                            <Text className={`font-rubik_bold text-sm ${type === 'income' ? 'text-black' : 'text-white/50'}`}>
                                Income
                            </Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View className="flex-row justify-between items-center mb-8">
                        ...
                        >
                            {isLoading ? (
                                ...
                                <>
                                    <Text className="text-white font-rubik_bold text-lg mr-2">
