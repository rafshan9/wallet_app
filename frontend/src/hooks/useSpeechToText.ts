...
//                 function toWhisperFileUri(uri: string): string {
//                     // Collapse "file:/" or "file://" down to a clean "file:///..." form
//                     return uri.replace(/^file:\/+/, 'file:///');
//                 }

//                 const cleanUri = toWhisperFileUri(result.fileUri);
...
//                 const { result: transcriptionResult, segments } =
