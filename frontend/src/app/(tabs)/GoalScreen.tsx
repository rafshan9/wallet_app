        ...
        <View className="flex-1 bg-background pt-16">
            ...
            <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 140 }}>
                ...
                <View className="flex-row justify-between items-center mb-6">
                    <Text className="text-xl font-jb_mono_bold">Your Goals</Text>
                    {goals.length > 0 && (
                        <TouchableOpacity activeOpacity={0.8} onPress={() => setIsModalOpen(true)} className="flex-row items-center bg-black border-2 border-black/40 rounded-full px-6 py-4">
                            <Text className="font-jb_mono_bold text-white">+</Text>
                            <Text className="text-sm font-jb_mono_bold text-white ml-1">Add New</Text>
                        </TouchableOpacity>
                    )}
                </View>
                ...
                {goals.length === 0 ? (
                    <View className="items-center justify-center py-12 mt-4 bg-white rounded-3xl ">
                        ...
                        <Text className="text-xl font-jb_mono_bold text-black mb-2">No goals yet</Text>
                        <Text className="text-gray-500 font-jb_mono_medium text-center mb-6 px-8">
                        ...
                        <TouchableOpacity onPress={() => setIsModalOpen(true)} className="bg-black px-8 py-4 rounded-full">
                            <Text className="text-white font-jb_mono_bold">Create Your First Goal</Text>
                        </TouchableOpacity>
                    </View>
                ) : (
                    <>
                        ...
                        {activeGoals.length > 0 && (
                            <View className="mb-4">
                                <Text className="text-sm font-jb_mono_bold text-black mb-4 uppercase tracking-wider">In Progress</Text>
                        ...
                        {completedGoals.length > 0 && (
                            <View className="mt-4">
                                <Text className="text-sm font-jb_mono mb-4 uppercase tracking-wider">Completed</Text>
