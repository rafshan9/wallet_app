    ...
    return (
        <View className="flex-1 bg-very_dark_blue pt-16 px-6">
            ...
            <View className="flex-row items-center justify-between mb-8">
                ...
                <Text className="text-2xl text-white font-jb_mono_bold mx-4 flex-1" numberOfLines={1}>{goal.name}</Text>
            </View>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
                ...
                <Text className="text-xl font-jb_mono_bold mb-4 text-white">Contribution History</Text>

                {contributions.length === 0 ? (
                    <Text className="text-center text-gray-400 font-jb_mono_medium py-8">No contributions yet.</Text>
                ) : (
